...
\begin{equation}
    \psi(x, y, \mu, \eta) = \begin{cases}
        \frac{S}{\sigma_t} \left(1 - \exp\left[-\frac{\sigma_t}{\mu} x  \right] \right), & \eta x \leq \mu y\\
...
An example of the solution shape for $\eta > \mu > 0$ can be seen in \autoref{fig:solution}, and the solution along the characteristic line can be seen in \autoref{fig:characteristic}. The solution along the characteristic line asymptotically approaches the infinite-medium solution, $S/\sigma_t$ (see \autoref{eq:param-solution}). This is also the solution in 1d slab geometry for $\mu = 1$.

\begin{figure}[h]
    \centering
    \begin{subfigure}{0.48\textwidth}
        \includegraphics[width=\linewidth]{soln.png}
        \caption{}
    \end{subfigure}
    \begin{subfigure}{0.48\textwidth}
        ...
        \caption{}
    \end{subfigure}
    \caption{Example solution for $\eta > \mu > 0$}\label{fig:solution}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[width=0.45\linewidth]{characteristic.png}
    \caption{Solution along characteristic line}\label{fig:characteristic}
\end{figure}
...
\begin{equation}
    \psi(x, y, \mu, \eta) = \begin{cases}
        \frac{S}{\sigma_t} \left(1 - \exp\left[-\frac{\sigma_t}{\mu} (x-a)  \right] \right), & \eta (x-a) \leq \mu (y-a)\\
...
\begin{equation}
    \psi(x, y, \mu, \eta) = \begin{cases}
        \frac{S}{\sigma_t} \left(1 - \exp\left[-\frac{\sigma_t}{\mu} (x-a)  \right] \right), & \eta (x-a) \leq \mu y\\
